...
import type { IExperience } from "../interfaces/experiences.interface";
...
const experiences: IExperience[] = [
  ...
  },
  {
    ...
    startYear: 2025,
    endMonth: "Present",
    endYear: "", // Placeholder for Present
    // Interface says endYear is number. JSON had "" for Present. I need to check how it's used.
    // In AboutMe.tsx: {experience.endMonth} {experience.endYear}
    // If endYear is empty string in JSON, it renders nothing.
    // Interface says number. This is a conflict.
    // I will use 0 for now and fix the interface or usage.
    // Actually, let's check usage in AboutMe.tsx again.
    // It renders directly.
    city: "Rio de Janeiro",
    country: "Brazil",
    responsibilities: [
